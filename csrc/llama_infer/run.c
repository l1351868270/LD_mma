...
// nvcc -O3 -o run run.c -lm -g
// ./run stories42M_fp32.bin -t 0.8 -n 256 -i "One day, Lily met a Shoggoth"
// ./run stories15M_fp32.bin -t 0.8 -n 256 -i "One day, Lily met a Shoggoth"
// ./run stories15M_fp32.bin -t 0.8 -n 256 -i "One day, Lily met a Shoggoth"
