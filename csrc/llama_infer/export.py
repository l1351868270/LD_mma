# Adapted from https://github.com/karpathy/llama2.c/blob/master/export.py
# python export.py llama2_7b_fb32.bin --meta-llama /mnt/e/code/github/facebookresearch/llama/llama-2-7b --version=1 --dtype=fp32
# python export.py stories15M_fb32.bin --checkpoint ./stories15M.pt --version=1 --dtype=fp32
# python export.py stories42M_fb32.bin --checkpoint ./stories42M.pt --version=1 --dtype=fp32
# python export.py stories42M_fb32.bin --checkpoint ./stories42M.pt --version=0 --dtype=fp32
# python export.py stories42M_fb32.bin --checkpoint ./stories42M.pt --version=0 --dtype=fp32
# python export.py stories42M_fp16.bin --checkpoint ./stories42M.pt --version=3 --dtype=fp32

# python export.py stories15M_fp32.bin --checkpoint ./stories42M.pt --version=0 --dtype=fp32
# python export.py stories15M_fp16.bin --checkpoint ./stories42M.pt --version=3 --dtype=fp16
...
def serialize_fp16(file, tensor):
    ...
    d = tensor.detach().cpu().view(-1).to(torch.float16).numpy().astype(np.float16)
...
def legacy_fp16_export(model, filepath):
    """ Original export of llama2.c bin files, i.e. version v0 """
    out_file = open(filepath, 'wb')
...
def model_export(model, filepath, version, dtype=torch.float32):
    ...
    if version == 0:
        ...
        legacy_fp16_export(model, filepath)
    else:
