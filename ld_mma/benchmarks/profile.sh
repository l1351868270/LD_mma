...
ncu --csv --log-file c.csv --cache-control=all --clock-control=base --metrics l1tex__data_bank_conflicts_pipe_lsu_mem_shared_op_ld.sum python ./ld_mma/benchmarks/matmul_benchmark.py
